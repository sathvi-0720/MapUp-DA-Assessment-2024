...
#     """
#     # Decode the polyline string to a list of (latitude, longitude) pairs
...
# if _name_ == "_main_":
#     # Example polyline string (replace with your input)
#     polyline_str = input("Enter polyline string: ")

#     # Get the DataFrame with latitude, longitude, and distance
